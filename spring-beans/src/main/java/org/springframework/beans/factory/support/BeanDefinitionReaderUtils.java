...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		/**
		 * 将beanDefinitionHolder这个数据结构包含的信息注册到DefaultListableBeanFactory
		 * register是AnnotationConfigApplicationContext类，而AnnotationConfigApplicationContext继承GenericApplicationContext
		 * 所以：
		 * 		GenericApplicationContext#registerBeanDefinition
		 * 			DefaultListableBeanFactory#registerBeanDefinition
		 * 最终调用的是DefaultListableBeanFactory#registerBeanDefinition方法，也是核心
		 */
